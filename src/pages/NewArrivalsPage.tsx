...
export function NewArrivalsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Hàng Mới Về" description="Cập nhật những mẫu thời trang mới nhất tại NOVAWEAR." url="/new-arrivals" keywords="hàng mới, new arrivals, thời trang mới" />
      <Header />

      <main className="flex-1">
        <div className="bg-muted/40 border-b border-border/50 py-6 md:py-8">
          <div className="container px-4 sm:px-6">
            <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold">Hàng Mới Về</h1>
            <p className="text-muted-foreground mt-1.5 text-sm sm:text-base">
              {loading ? 'Đang tải...' : `${total} sản phẩm mới`}
            </p>
            ...
            <div className="flex-1">
              ...
              {loading ? (
                ...
                <div className="text-center py-14 md:py-20">
                  <h2 className="font-display text-lg sm:text-xl font-semibold mb-2">Chưa có hàng mới về</h2>
