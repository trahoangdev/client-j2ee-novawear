...
export function SalePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO title="Khuyến Mãi" description="Sản phẩm đang giảm giá tại NOVAWEAR. Mua ngay kẻ o hết!" url="/sale" keywords="giảm giá, sale, khuyến mãi, thời trang" />
      <Header />

      <main className="flex-1">
        <div className="bg-muted/40 border-b border-border/50 py-6 md:py-8">
          <div className="container px-4 sm:px-6">
            <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold">Sản Phẩm Khuyến Mãi</h1>
            <p className="text-muted-foreground mt-1.5 text-sm sm:text-base">
              {loading ? 'Đang tải...' : `${total} sản phẩm đang giảm giá`}
            </p>
            ...
            <div className="flex-1">
              ...
              {loading ? (
                ...
                <div className="text-center py-14 md:py-20">
                  <h2 className="font-display text-lg sm:text-xl font-semibold mb-2">Chưa có sản phẩm khuyến mãi</h2>
