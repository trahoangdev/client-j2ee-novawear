      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="relative h-full container flex items-center px-4 sm:px-6">
            ...
            >
              <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-snug tracking-wide whitespace-pre-line mb-8 drop-shadow-md">
                {slide.title || 'NOVAWEAR'}
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-background/90 leading-relaxed mb-10 max-w-2xl drop-shadow-sm">
                {slide.subtitle}
              </p>
              <Button
                size="lg"
